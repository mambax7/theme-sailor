...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<{xoImgUrl}>css/cubeportfolio.min.css">
    <link rel="stylesheet" type="text/css" href="<{xoImgUrl}>css/style.css">

    <link href="<{xoImgUrl}>plugins/flexslider/flexslider.css" rel="stylesheet" media="screen" />


<!-- Theme skin -->
<link id="t-colors" href="<{xoImgUrl}>skins/default.css" rel="stylesheet" />
...
<script src="<{xoImgUrl}>js/modernizr.custom.js"></script>
<script src="<{xoImgUrl}>js/jquery.easing.1.3.js"></script>
<script src="<{xoImgUrl}>js/bootstrap.min.js"></script>
<script src="<{xoImgUrl}>plugins/flexslider/jquery.flexslider-min.js"></script>
<script src="<{xoImgUrl}>plugins/flexslider/flexslider.config.js"></script>
<script src="<{xoImgUrl}>js/jquery.appear.js"></script>
<script src="<{xoImgUrl}>js/stellar.js"></script>
<script src="<{xoImgUrl}>js/classie.js"></script>
<script src="<{xoImgUrl}>js/uisearch.js"></script>
<script src="<{xoImgUrl}>js/jquery.cubeportfolio.min.js"></script>
<script src="<{xoImgUrl}>js/google-code-prettify/prettify.js"></script>
<script src="<{xoImgUrl}>js/animate.js"></script>
